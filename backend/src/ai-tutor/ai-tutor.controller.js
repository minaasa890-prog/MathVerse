...
let AiTutorController = (() => {
    let _classDecorators = [Controller('ai-tutor')];
    ...
    var AiTutorController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _practice_decorators = [Get('practice/:studentId')];
            _report_decorators = [Get('report/:studentId')];
            _chat_decorators = [Post('chat')];
            ...
            AiTutorController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        aiTutorService = __runInitializers(this, _instanceExtraInitializers);
        constructor(aiTutorService) {
            this.aiTutorService = aiTutorService;
        }
        async practice(studentId) {
            return this.aiTutorService.practice(Number(studentId));
        }
        async report(studentId) {
            return this.aiTutorService.report(Number(studentId));
        }
        async chat(data) {
            return this.aiTutorService.chat(data);
        }
    };
    return AiTutorController = _classThis;
})();
export { AiTutorController };
