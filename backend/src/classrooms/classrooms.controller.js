...
let ClassroomsController = (() => {
    let _classDecorators = [Controller('classrooms')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _create_decorators;
    let _addStudent_decorators;
    ...
    var ClassroomsController = class {
        ...
        static {
            ...
            _addStudent_decorators = [Post(':id/add-student')];
            _assignTeacher_decorators = [Post(':classroomId/teacher/:teacherId')];
            __esDecorate(this, null, _create_decorators, { kind: "method", name: "create", static: false, private: false, access: { has: obj => "create" in obj, get: obj => obj.create }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _addStudent_decorators, { kind: "method", name: "addStudent", static: false, private: false, access: { has: obj => "addStudent" in obj, get: obj => obj.addStudent }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        // ================= ADD STUDENT =================
        async addStudent(classroomId, body) {
            return this.classroomsService.addStudent(Number(body.studentId), Number(classroomId));
        }
        // ================= ASSIGN TEACHER =================
        async assignTeacher(classroomId, teacherId) {
            return this.classroomsService.assignTeacher(Number(classroomId), Number(teacherId));
        }
    };
